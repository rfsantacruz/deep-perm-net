...
void caffe_cpu_gels(const int m, const int n, const int nrhs, Dtype* A, Dtype* B);
...
template <typename Dtype>
void caffe_gpu_dgemm(const cublasSideMode_t mode,
    const int M, const int N,
    const Dtype* A, const Dtype* x, Dtype* B);
